  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/surbhi.chourasia.18?mibextid=LQQJ4d"
            ...
            <li>
              <a
                href="https://www.instagram.com/_.suriiii._?igsh=MjVvbjV3dnBtMzRh"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/surabhi-chourasia-2752951b7"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">© DYNAMIC. All rights reserved </p>
        {/* <div className="footer--social--icon">
          <ul>
            <li>
              <Link
